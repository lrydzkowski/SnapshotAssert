...
- FROM: `### Requirement: The consumer resolves SimpleVerify exclusively from the local artifacts feed`
- TO: `### Requirement: The consumer resolves SnapshotAssert exclusively from the local artifacts feed`
