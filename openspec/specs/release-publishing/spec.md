...
Define how tagged releases are published to nuget.org: full revalidation of the tagged commit, tag-to-csproj version agreement, credential-free authentication via NuGet Trusted Publishing, and loud failure on duplicate versions.
