...
Define the core snapshot verification flow: awaitable `Verify` entry points, received/verified file lifecycle, pass/fail semantics, diff-tool integration, and line-ending discipline.
